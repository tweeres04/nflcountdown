...
> = {
	...
	CFL: { fullName: 'Canadian Football League', seasonTerm: 'kickoff', titleKeyword: 'CFL Season', brandColor: '#C42127' },
	NSL: { fullName: 'Northern Super League', seasonTerm: 'kickoff', titleKeyword: 'NSL Season', brandColor: '#00654A' },
	CEBL: { fullName: 'Canadian Elite Basketball League', seasonTerm: 'tip-off', titleKeyword: 'CEBL Season', brandColor: '#1A1A1A' },
