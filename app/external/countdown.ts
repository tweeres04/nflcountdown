/**
 * Tyler note 2024-08-09:
 *
 * I had to copy this module and turn it into an ES module since I couldn't get vite and rollup to build it for production. It was giving the error:
 * `app/routes/$teamAbbrev.tsx (5:7): "default" is not exported by "node_modules/countdown/countdown.js", imported by "app/routes/$teamAbbrev.tsx".`
 */
