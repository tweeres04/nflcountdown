...
> = {
	...
	CFL: { fullName: 'CFL Countdown', shortName: 'CFL', brandColor: '#C42127' },
	NSL: { fullName: 'NSL Countdown', shortName: 'NSL', brandColor: '#00654A' },
	CEBL: { fullName: 'CEBL Countdown', shortName: 'CEBL', brandColor: '#1A1A1A' },
