...
>(({ className, children, ...props }, ref) => (
	<DialogPortal>
		...
		<DialogPrimitive.Content
			ref={ref}
			className={cn(
				'overflow-y-auto max-h-[80%] w-[95%] fixed left-[50%] top-[50%] z-50 grid max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-stone-200 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg dark:border-stone-800 dark:bg-stone-950',
				className
			)}
			{...props}
		>
...
const DialogFooter = ({
	...
	<div
		className={cn(
			'flex flex-col-reverse gap-1 sm:flex-row sm:justify-end sm:gap-2 md:justify-center',
			className
		)}
		{...props}
	/>
